...
const ThemeSwitcher = () => {
  const [isDayTheme, setIsDayTheme] = useState(true); // Assuming day theme is the initial state

  useEffect(() => {
    // Check the localStorage for the theme preference
  ...
  const handleThemeToggle = () => {
    const newTheme = isDayTheme ? 'night' : 'winter';
