...
<div ><h1 className='py-6 text-base font-semibold leading-7 text-gray-900'>Bem vindo de volta, <span className='text-lg font-semibold leading-6 texto'>{localStorage.getItem('userName')}</span></h1></div>
